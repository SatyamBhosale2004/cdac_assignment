...
public class MenuOptimized {
	...
	public static void main(String[] args) {
        ...
        final int SAVE = 5;
        final int LOAD = 6;
        String path = "D:\\Thinkpad\\satyam_d\\cdac\\java\\eclipse\\day10\\src\\assignment\\EmployeeList.txt";
			...
			switch(choice) {
				...
				case LOAD:
					...
					try(FileInputStream fs = new FileInputStream(path);
						...
						count = 0;
						while(true) {
							empObj[count] = (Employee) in.readObject();
							count ++;
						}
						
					}catch(EOFException e) {
						for(int iTmp = 0 ; iTmp< count; iTmp++) {
							displayEmployee(empObj[iTmp]);
						}
						System.out.println("All emp loaded successfully");
					}
...
class Engineer extends Employee implements Serializable{
...
class SalesPerson extends Employee implements Serializable{
